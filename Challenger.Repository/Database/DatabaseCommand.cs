...
namespace Challenger.Repository.Database
{
    ...
    {
        public async static Task<int> InserirDados(string query, IDbConnection connection, DynamicParameters parameters) => await connection.ExecuteAsync(query, parameters);
